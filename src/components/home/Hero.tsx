  ...
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0">
        ...
        <div className="h-[360px] w-full bg-[url('/img/bg-hero.jpg')] bg-cover bg-center" />
      ...
      <div className="relative mx-auto max-w-6xl px-4 h-[360px] flex items-center">
        <div className="text-white drop-shadow">
          <h1 className="text-3xl md:text-4xl font-extrabold">Jadwalkan Perjalanan Umroh Anda, Sekarang!</h1>
